namespace MathWizzz.Views
{
    partial class frmViewProfile
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.grpEditUser.Controls.Add(this.label6);
            this.grpEditUser.Controls.Add(this.label7);
            this.grpEditUser.Controls.Add(this.txtNewConfirmPwd);
            this.grpEditUser.Controls.Add(this.txtNewPwd);
            this.grpEditUser.Controls.Add(this.txtOldPwd);
